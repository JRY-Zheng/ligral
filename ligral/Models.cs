...
namespace Ligral
{
    ...
    class Scope : Model
    {
        ...
        public override void Release()
        {
            ...
            string dataFile = System.IO.Path.Join(currentDirectory, Program.OutputFolder, fileName+".csv");
            ...
            string scriptsFile = System.IO.Path.Join(currentDirectory, Program.OutputFolder, fileName+".py");
